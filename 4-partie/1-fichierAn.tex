...
Spark syntax requires SMEs to have experience in data engineering &
...
Standard SQL interface, making it easy to use for users familiar with SQL \ \hline
\textbf{Cost} &
...
\begin{figure}[H]
\centering
\includegraphics[width=\linewidth]{images/delta-lake-folder.png}
...
\begin{figure}[H]
\centering
\includegraphics[width=\linewidth]{images/izicap-portal.png}
\caption{Izicap Portal}\label{fig:izicap-1}
\end{figure}

\begin{figure}[H]
\centering
\includegraphics[width=\linewidth]{images/revenue.png}
